...
//Pins for Motor
#define A_1 12 // for motor A direction, high is CW and low is CCW
#define A_2 3 // Pin that controls speed for motor A
#define ENA 9 // Pin that controls brake for motor A
#define B_1 13 // for motor B direction, high is CW and low is CCW
#define B_2 11// Pin that controls speed for motor B
#define ENB 8// Pin that controls speed for motor B
